...
hoyeste_verdi_2023 = df['2023'].max()
hoyeste_kommuner_2023 = df[df['2023'] == hoyeste_verdi_2023]['Region'].tolist()
...
laveste_verdi_2023 = df['2023'].min()
laveste_kommuner_2023 = df[df['2023'] == laveste_verdi_2023]['Region'].tolist()
